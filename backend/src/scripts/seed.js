...
async function runSeed() {
    ...
    const rawCatalogData = [
        ...
        { brandId: getBrandId('Adidas'), name: 'Gazelle Indoor', description: 'Retro terrace style meets modern street culture.', basePrice: '10499.00', category: 'Classic', isNew: true, isOnSale: false, imageUrl: 'https://images.unsplash.com/photo-1539185441755-769473a23570?auto=format&fit=crop&w=800&q=80' },
