...
function buildCatalog(getBrandId) {
    return [
        ...
        { brandId: getBrandId('Nike'), name: 'ZoomX Vaporfly Next% 2',       description: 'Advanced carbon-plate racing shoe engineered for peak marathon speed.',                     basePrice: '21999.00', category: 'Running',      isNew: false, isOnSale: true,  imageUrl: 'https://images.unsplash.com/photo-1608231387042-66d1773070a5?auto=format&fit=crop&w=800&q=80' },
