...
import { Package, PlusCircle, ChevronDown, Download, Archive, ArrowRight, Star } from 'lucide-react';
                                    ...
                                    <div className="flex flex-wrap items-center justify-between gap-6 border-t border-stone-50 pt-5 mt-auto">
                                        ...
                                        {order.status === 'DELIVERED' ? (
                                            <button
                                                ...
                                                className="flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-stone-900 hover:bg-stone-900 hover:text-white border border-stone-900 px-4 py-2 transition-all"
                                            >
                                                <Star size={12} />
                                                Evaluate
                                            </button>
                                        ) : (
                                            <p className="text-[9px] font-bold uppercase tracking-widest text-stone-300 italic">
                                                * Logistics pending
                                            </p>
                                        )}
                                    </div>
